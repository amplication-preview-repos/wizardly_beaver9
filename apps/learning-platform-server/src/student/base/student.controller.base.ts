...
import { CertificateFindManyArgs } from "../../certificate/base/CertificateFindManyArgs";
...
export class StudentControllerBase {
  ...
  async findCertificates(
    ...
    const query = plainToClass(CertificateFindManyArgs, request.query);
    const results = await this.service.findCertificates(params.id, {
      ...query,
      select: {
        createdAt: true,
        id: true,
  ...
  @common.Post("/:id/certificates")
  @nestAccessControl.UseRoles({
    resource: "Student",
    action: "update",
    possession: "any",
  })
  async connectCertificates(
    @common.Param() params: StudentWhereUniqueInput,
    @common.Body() body: CertificateWhereUniqueInput[]
  ): Promise<void> {
    const data = {
      certificates: {
        connect: body,
  ...
  @common.Delete("/:id/certificates")
  @nestAccessControl.UseRoles({
    resource: "Student",
    action: "update",
    possession: "any",
  })
  async disconnectCertificates(
    @common.Param() params: StudentWhereUniqueInput,
    @common.Body() body: CertificateWhereUniqueInput[]
  ): Promise<void> {
    const data = {
