...
@InputType()
class CompletionCreateNestedManyWithoutStudentsInput {
...
export { CompletionCreateNestedManyWithoutStudentsInput as CompletionCreateNestedManyWithoutStudentsInput };
